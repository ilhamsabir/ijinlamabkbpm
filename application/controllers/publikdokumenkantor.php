<?php
class Publikdokumenkantor extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumenkantor/index';
   ...
   $data['ambil_imgkantor'] = $this->m_app->ambil_imgkantor($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenkantor',$data);
...
public function add(){
        ...
        $nmfile = "fkantor_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumenkantor'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumenkantor'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
