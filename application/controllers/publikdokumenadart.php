<?php
class Publikdokumenadart extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumenadart/index';
   ...
   $data['ambil_fileadart'] = $this->m_app->ambil_fileadart($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenadart',$data);
...
public function add(){
        ...
        $nmfile = "adart_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
