<?php
class Publikdokumenlambang extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumenlambang/index';
   ...
   $data['ambil_imglambang'] = $this->m_app->ambil_imglambang($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenlambang',$data);
...
public function addlambang(){
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumenlambang'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumenlambang'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
