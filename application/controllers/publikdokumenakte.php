<?php
class Publikdokumenakte extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumenakte/index';
   ...
   $data['ambil_fileakte'] = $this->m_app->ambil_fileakte($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenakte',$data);
...
public function add(){
        ...
        $nmfile = "akte_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumenakte'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumenakte'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
