<?php
class Publikdokumendomisili extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumendomisili/index';
   ...
   $data['ambil_filedomisili'] = $this->m_app->ambil_filedomisili($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumendomisili',$data);
  ...
  function hapus_data(){
        ...
        redirect("publikdokumendomisili");
    }
...
public function add(){
        ...
        $nmfile = "domisili_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumendomisili'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumendomisili'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
