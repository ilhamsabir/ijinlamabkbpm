<?php
class Publikdokumenproposal extends CI_Controller{
   ...
   $data['ambil_fileproposal'] = $this->m_app->ambil_fileproposal($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenproposal',$data);
  ...
  function hapus_data(){
        ...
        redirect("publikdokumenproposal");
    }
...
public function add(){
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumenproposal'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumenproposal'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
