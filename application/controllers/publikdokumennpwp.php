<?php
class Publikdokumennpwp extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumennpwp/index';
   ...
   $data['ambil_filenpwp'] = $this->m_app->ambil_filenpwp($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumennpwp',$data);
...
public function add(){
        ...
        $nmfile = "npwp_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumennpwp'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumennpwp'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
