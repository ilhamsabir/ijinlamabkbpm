<?php
class Publikdokumentujuan extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumentujuan/index';
   ...
   $data['ambil_filetujuan'] = $this->m_app->ambil_filetujuan($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumentujuan',$data);
...
public function add(){
        ...
        $nmfile = "tujuan_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumentujuan'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumentujuan'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
