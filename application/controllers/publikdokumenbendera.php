<?php
class Publikdokumenbendera extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumenbendera/index';
   ...
   $data['ambil_imgbendera'] = $this->m_app->ambil_imgbendera($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenbendera',$data);
...
public function add(){
        ...
        $nmfile = "bendera_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumenbendera'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumenbendera'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
