<?php
class Publikdokumenfotoktp extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumenfotoktp/index';
   ...
   $data['ambil_filefotoktp'] = $this->m_app->ambil_filefotoktp($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenfotoktp',$data);
...
public function add(){
        ...
        $nmfile = "fktp_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumenfotoktp'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumenfotoktp'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
