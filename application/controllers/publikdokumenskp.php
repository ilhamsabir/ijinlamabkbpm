<?php
class Publikdokumenskp extends CI_Controller{
   ...
   $config['base_url'] = base_url().'publikdokumenskp/index';
   ...
   $data['ambil_fileskp'] = $this->m_app->ambil_fileskp($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenskp',$data);
...
public function add(){
        ...
        $nmfile = "skp_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumenskp'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumenskp'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
