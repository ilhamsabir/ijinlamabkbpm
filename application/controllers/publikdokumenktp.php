<?php
class Publikdokumenktp extends CI_Controller{
   ...
   $data['ambil_imgktp'] = $this->m_app->ambil_imgktp($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumenktp',$data);
...
public function add_ktp(){
        ...
        $nmfile = "sktp_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumenktp'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumenktp'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
