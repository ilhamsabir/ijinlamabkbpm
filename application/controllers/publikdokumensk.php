<?php
class Publikdokumensk extends CI_Controller{
   ...
   $data['ambil_filesk'] = $this->m_app->ambil_filesk($config['per_page'], $offset);
  
        $this->load->view('publik/v_dokumensk',$data);
...
public function add(){
        ...
        $nmfile = "sk_".time(); //nama file saya beri nama langsung dan diikuti fungsi time
        ...
        if($_FILES['filefoto']['name'])
        {
            if ($this->upload->do_upload('filefoto'))
            {
                ...
                redirect('publikdokumensk'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('publikdokumensk'); //jika gagal maka akan ditampilkan form upload
            }
          }
} 
