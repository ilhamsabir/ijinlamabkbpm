...
//        mendapatkan nama kota
        var skorganisasi=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("skorganisasi").value = skorganisasi;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenskp/add')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="fskp" />
             <div class="form-group">
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>Surat Keputusan Tentang Susunan Pengurus ORKESMAS </textarea>
                    </div>
              </div>
     ...
     <div class="col-xs-8">
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
                ...
                <div class="panel-heading">
                Data File Surat Keputusan Tentang Susunan Pengurus ORKESMAS</div>
                <div class="panel-body">
