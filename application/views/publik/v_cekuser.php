  ...
  <div class="content" style="min-height:460px">
    ...
    <div class="content-container">
      ...
      <div class="row">
       ...
       <?php if(isset($data_profile)){ foreach($data_profile as $row){ ?>

<form id="defaultForm" method="post" class="form-horizontal" action="<?php echo site_url('publikprofile/ubah')?>" enctype="multipart/form-data">
        ...
        <div class="col-lg-8">
         <input type="text" class="form-control" name="email" value="<?php echo $row->email;?>" />
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-8">
                      <input type="text" class="form-control" name="noktp"value="<?php echo $row->noktp;?>" />
                  </div>
                 </div>
                  <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-lg-8">
                      <input type="text" class="form-control" name="tempatlahir" value="<?php echo $row->tempatlahir;?>" />
                  </div>
                 </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-8">
                    <div id="dp-ex-4" class="input-group date" data-auto-close="true" data-date="<?php echo $row->tgllahir;?>" data-date-format="dd/mm/yyyy" data-date-autoclose="true">
                         <input class="form-control" type="text"name="tgllahir" value="<?php echo $row->tgllahir;?>" >
