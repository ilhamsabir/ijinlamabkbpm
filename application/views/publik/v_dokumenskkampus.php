...
//        mendapatkan nama kota
        var skkampus=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("skkampus").value = skkampus;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <div class="col-xs-4">
      ...
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
                ...
                Upload Surat Permohonan Dari Kampus/Lembaga</div>
                <div class="panel-body">

         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenskkampus/add');?>" enctype="multipart/form-data">
            <input type="text" name="kd_file" value="<?php echo $kd_file;?>"/>
            <input type="hidden" name="kd_user" value="<?php echo $this->session->userdata('ID');?>"/>
            <input type="hidden" name="kategori" value="fskkampus" />
             <div class="form-group">

                    <div class="col-sm-8">
                      <label class="control-label" style="text-align:right">File</label>
                      <input type="file" name="filefoto" required>
                    </div>
                  </div>
              <p> <small>Type File PDF max 5MB</small></p>
              <br/>
              <div class="form-group">
              <div class="col-sm-8">
                      <label class="control-label" style="text-align:right">Keterangan</label>
                      <textarea type="text" name="ket" readonly>File Surat Permohonan Dari Kampus/Lembaga</textarea>
                    </div>
              </div>
     ...
     <div class="col-xs-8">
      ...
      <?php echo $this->session->flashdata('pesan');?>
                ...
                <div class="panel-heading">
                Data File SUrat Keterangan</div>
                <div class="panel-body">
                 ...
                 <table class="table table-striped table-bordered responsive table-primary mb30">
                      ...
                      <tbody>
                        <?php
                                            ...
                                            foreach($ambil_fileskkampus as $row){
                                        ?>
                                         ...
                                         <tr onclick="javascript:pilih(this);">
                                            ...
                                            <td style="width:90px">
                                                ...
                                                <a class="btn btn-danger btn-xs" href="<?php echo site_url('Publikdokumenskkampus/hapus_data/'.$row->kd_file);?>"
