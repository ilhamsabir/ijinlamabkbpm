...
//        mendapatkan nama kota
        var proposal=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("proposal").value = proposal;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <div class="col-xs-4">
      ...
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenproposal/add');?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="fproposal" />
             <div class="form-group">
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>File Proposal /Abstrak</textarea>
                    </div>
              </div>
                 ...
                 <table class="table table-striped table-bordered responsive table-primary mb30">
                      ...
                      <tbody>
                        <?php
                                            ...
                                            foreach($ambil_fileproposal as $row){
                                        ?>
                                         ...
                                         <tr onclick="javascript:pilih(this);">
                                            ...
                                            <td style="width:90px">
                                                ...
                                                <a class="btn btn-danger btn-xs" href="<?php echo site_url('publikdokumenproposal/hapus_data/'.$row->kd_file);?>"
