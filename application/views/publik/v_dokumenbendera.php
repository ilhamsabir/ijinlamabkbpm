...
//        mendapatkan nama kota
        var bendera=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("bendera").value = bendera;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
                ...
                Upload Foto Bendera</div>
                <div class="panel-body">

         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenbendera/add')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="ibendera" />
             <div class="form-group">
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>Bendera Organisasi </textarea>
                    </div>
              </div>
                 ...
                 <table class="table table-striped table-bordered responsive table-primary mb30">
                      ...
                      <tbody>
                        <?php
                                            ...
                                            foreach($ambil_imgbendera as $row){
                                        ?>
