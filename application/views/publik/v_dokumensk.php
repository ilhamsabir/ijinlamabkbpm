...
//        mendapatkan nama kota
        var sk=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("sk").value = sk;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <div class="col-xs-4">
      ...
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumensk/add');?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="fsk" />
             <div class="form-group">
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>File Surat Keterangan</textarea>
                    </div>
              </div>
