...
//        mendapatkan nama kota
        var foto=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("foto").value = foto;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
                ...
                Upload Foto Anda Disini</div>
                <div class="panel-body">

         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenfoto/add_foto')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="ifoto" />
             <div class="form-group">
                    
                    <div class="col-sm-8">
                      <label class="control-label" style="text-align:right">Foto Anda</label>
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>Pas Foto Berwarna </textarea>
                    </div>
              </div>
                                        ...
                                        ?>
                                         ...
                                         <tr onclick="javascript:pilih(this);">
                                            ...
                                            <td style="width:90px">
                                                ...
                                                <a class="btn btn-danger btn-xs" href="<?php echo site_url('publikdokumenfoto/hapus_data/'.$row->kd_file);?>"
