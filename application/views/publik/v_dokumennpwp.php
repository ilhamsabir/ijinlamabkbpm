...
//        mendapatkan nama kota
        var npwporganisasi=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("npwporganisasi").value = npwporganisasi;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumennpwp/add')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="fnpwp" />
             <div class="form-group">
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>NPWP Atas Nama Organisasi  </textarea>
                    </div>
              </div>
     ...
     <div class="col-xs-8">
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
                ...
                <div class="panel-heading">
                Data Foto NPWP Atas Nama Organisasi </div>
                <div class="panel-body">
