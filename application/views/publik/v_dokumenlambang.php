...
//        mendapatkan nama kota
        var lambang=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("lambang").value = lambang;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
                ...
                Upload Foto Lambang / Logo</div>
                <div class="panel-body">

         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenlambang/addlambang')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="ilambang" />
             <div class="form-group">
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>Lambang Organisasi </textarea>
                    </div>
              </div>
                 ...
                 <table class="table table-striped table-bordered responsive table-primary mb30">
                      ...
                      <tbody>
                        <?php
                                            ...
                                            foreach($ambil_imglambang as $row){
                                        ?>
