...
//        mendapatkan nama kota
        var tujuanorganisasi=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("tujuanorganisasi").value = tujuanorganisasi;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumentujuan/add')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="ftujuan" />
             <div class="form-group">
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>Tujuan dan programkerja organisasi  </textarea>
                    </div>
              </div>
     ...
     <div class="col-xs-8">
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
                ...
                <div class="panel-heading">
                Data File Tujuan & Program Kerja Organisasir</div>
                <div class="panel-body">
                 ...
                 <table class="table table-striped table-bordered responsive table-primary mb30">
                      ...
                      <tbody>
                        <?php
                                            ...
                                            foreach($ambil_filetujuan as $row){
                                        ?>
