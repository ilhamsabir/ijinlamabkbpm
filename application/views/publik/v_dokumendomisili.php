...
//        mendapatkan nama kota
        var domisiliorganisasi=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("domisiliorganisasi").value = domisiliorganisasi;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumendomisili/add')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="fdomisili" />
             <div class="form-group">
              ...
              <div class="col-sm-8">
                      ...
                      <textarea type="text" name="ket" readonly>FOTOCOPY KTP Pengurus </textarea>
                    </div>
              </div>
     ...
     <div class="col-xs-8">
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
                ...
                <div class="panel-heading">
                Data File Surat Keterangan Domisili Yang Telah Dilegalisi</div>
                <div class="panel-body">
                 ...
                 <table class="table table-striped table-bordered responsive table-primary mb30">
                      ...
                      <tbody>
                        <?php
                                            ...
                                            foreach($ambil_filedomisili as $row){
                                        ?>
