...
//        mendapatkan nama kota
        var izinkantor=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("izinkantor").value = izinkantor;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenizin/add')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="fizin" />
             <div class="form-group">
              ...
              <div class="form-group">
              <div class="col-sm-8">
                      <label class="control-label" style="text-align:right">Ket </label>
                      <textarea type="text" name="ket" readonly>Bukti Kepemilikan Atau Surat Perjanjian Kontrak Atau Izin Pakai Kantor/Sekretariat ORKESMAS </textarea>
                    </div>
              </div>
