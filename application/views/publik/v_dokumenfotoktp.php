...
//        mendapatkan nama kota
        var ktporganisasi=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("ktporganisasi").value = ktporganisasi;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenfotoktp/add')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="ffotoktp" />
     ...
     <div class="col-xs-8">
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
                ...
                <div class="panel-heading">
                Data File FOTOCOPY KTP Pengurus</div>
                <div class="panel-body">
                 ...
                 <table class="table table-striped table-bordered responsive table-primary mb30">
                      ...
                      <tbody>
                        <?php
                                            ...
                                            foreach($ambil_filefotoktp as $row){
                                        ?>
