...
//        mendapatkan nama kota
        var akteorganisasi=row.cells[0].innerHTML;
//        memasukkan nama kota dalam form
        window.opener.parent.document.getElementById("akteorganisasi").value = akteorganisasi;
//        menutup pop up
        window.close();
    }
...
<body>
  ...
  <?php echo  $this->session->set_flashdata("pesan");?>
      <div class="panel panel-success" style="margin-top:20px;">
         ...
         <form method="post" class="form-horizontal" action="<?php echo site_url('publikdokumenakte/add')?>" enctype="multipart/form-data">     
            ...
            <input type="hidden" name="kategori" value="fakte" />
             <div class="form-group">
              ...
              <p> <small>Type File PDF</small></p>  
              <br/>
              <div class="form-group">
              <div class="col-sm-8">
                      <label class="control-label" style="text-align:right">Ket Gambar</label>
                      <textarea type="text" name="ket" readonly>Akte Pendirian / Status ORKESMAS  </textarea>
                    </div>
              </div>
     ...
     <div class="col-xs-8">
      <div class="panel panel-success" style="margin-top:20px;background:#eee">
                ...
                <div class="panel-heading">
                Data File Akte Pendirian Atau Status ORKESMAS Yang Disahkan Notaris Dan Dilegalisir</div>
                <div class="panel-body">
