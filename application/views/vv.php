	...
	<!--Features-->
	<div id="features">
		<div class="dot-features">
			<a class="icon-user1" href="#features"><i class="fa fa-check"></i>
</a>
		</div>
		...
		<div class="container">
			...
			<div class="row">	
			   <div class="panel panel-danger" style="border-color:#cc4040;border-radius:0">
                <div class="panel-heading" style="background-color:#cc4040;color:#fff;border-radius:0">Silahkan Lengkapi Data Diri Anda Di Bawah Ini</div>
 			  ...
 			  <div class="modal-dialog">
				...
				<div class="loginmodal-container">
				  ...
				  <form action="<?= site_url('home/cek_login')?>" method="post">
					...
					<button type="submit" class="btn btn-info btn-lg" value="Login">Login</button>
				  </form>
	...
	<!- -End Screens-->
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="row-stat" style="border:4px solid #69cbe0">
            <p class="row-stat-label">Jumlah Pengajuan</p>
            <h3 class="row-stat-value">00</h3>
            
          </div> <!-- /.row-stat -->
        </div> <!-- /.col -->

        <div class="col-sm-6 col-md-3">
          <div class="row-stat" style="border:4px solid #e95050">
            <p class="row-stat-label">Permohonan Pending</p>
            <h3 class="row-stat-value">00</h3>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="row-stat" style="border:4px solid #65e436">
            <p class="row-stat-label">Permohonan Upproved</p>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="row-stat" style="border:4px solid #fccd00">
            <p class="row-stat-label">Permohonan Sukses</p>
